...
setPointAlg <- function(beta_expo,sigmaPar,csvdata,column_select){
  ...
  #Add sources of the auxiliary probability functions calculation
  ...
  print("columnas en el original")
  print(length(column_select))
  print("columnas en el nuevo")
  print(subset_values_raw_sub)
